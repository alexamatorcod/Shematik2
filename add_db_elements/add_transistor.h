#ifndef ADD_TRANSISTOR_H
#define ADD_TRANSISTOR_H

#include "addtodbaseelem.h"
#include "ui_addtodbaseelem.h"

namespace Ui {
class Add_Transistor;
}

class Add_Transistor : public AddtoDBaseElem
{
    Q_OBJECT

public:
    explicit Add_Transistor();
    ~Add_Transistor();
